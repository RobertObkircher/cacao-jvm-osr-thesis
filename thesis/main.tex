...
\setdate{30}{10}{2024} % Set date with 3 arguments: {day}{month}{year}.
...
% Switch to arabic numbering and start the enumeration of chapters in the table of content.
    ...
    JLLVM\cite{jllvm} is an LLVM-based best-effort implementation of a JVM that was developed for a university course.
    It was extended with support for OSR as part of the bachelor thesis
    \textit{Implementing On-Stack-Replacement in an LLVM-based JVM}\cite{osr-jllvm}.
